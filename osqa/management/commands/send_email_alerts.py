...
from osqa.models import KeyValue, Activity, User, QuestionSubscription
    ...
    def send_digest(self, name, char_in_db, control_date):
        ...
        for u in users:
            ...
            if context['new_users'] or context['activity_in_subscriptions'] or context['new_questions']:
                send_email(digest_subject, (u.username, u.email), "osqa/notifications/digest.html", context, threaded=False)
