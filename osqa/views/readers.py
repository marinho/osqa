...
from osqa.const import *
from osqa.utils.forms import get_next_url
from osqa.models.question import question_view
import decorators
...
def question_search(request, keywords):
    ...
    from osqa.modules import get_handler
...
def tags(request):#view showing a listing of available tags - plain list
    ...
    return render_to_response('osqa/tags.html', {
                                            "tags" : tags,
                                            "stag" : stag,
                                            "tab_id" : sortby,
                                            "keywords" : stag,
...
def question(request, id, slug):
    ...
    return render_to_response('osqa/question.html', {
        "question" : question,
        "answer" : answer_form,
...
REVISION_TEMPLATE = template.loader.get_template('osqa/node/revision.html')
...
def revisions(request, id):
    ...
    return render_to_response('osqa/revisions_question.html', {
                              'post': post,
                              'revisions': rev_ctx,
                              }, context_instance=RequestContext(request))
