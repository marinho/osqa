...
from osqa.forms import CloseForm
from django.core.urlresolvers import reverse
from django.contrib.auth.decorators import login_required
from osqa.utils.decorators import ajax_method, ajax_login_required
...
def close(request, id):#close question
    ...
    if request.method == 'POST':
        ...
        form = CloseForm()
        return render_to_response('osqa/close.html', {
            'form' : form,
            'question' : question,
...
def reopen(request, id):#re-open question
    ...
    if request.method == 'POST' :
        ...
        return render_to_response('osqa/reopen.html', {
            'question' : question,
            }, context_instance=RequestContext(request))
