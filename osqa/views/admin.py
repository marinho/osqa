...
from osqa.settings.forms import SettingsSetForm

from osqa.models import Activity, Question, Answer, User, Node
...
@super_user_required
def index(request):
    return render_to_response('osqa/osqaadmin/index.html', {
        'sets': get_all_sets(),
...
def settings_set(request, set_name):
    ...
    return render_to_response('osqa/osqaadmin/set.html', {
        'form': form,
...
def go_bootstrap(request):
    ...
    try:
        from osqa_modules.default_badges import settings as dbsets
