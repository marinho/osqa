...
from django.core.urlresolvers import reverse
from osqa.forms import *
from osqa.utils.html import sanitize_html
from osqa.authentication import user_updated
...
def users(request):
    ...
    return render_to_response('osqa/users/users.html', {
                                "users" : users,
                                "suser" : suser,
                                "keywords" : suser,
                                "tab_id" : sortby,
...
@user_view('osqa/users/stats.html', 'stats', _('user profile'), _('user profile overview'))
...
@user_view('osqa/users/recent.html', 'recent', _('recent user activity'), _('profile - recent activity'))
...
@user_view('osqa/users/votes.html', 'votes', _('user vote record'), _('profile - votes'), True)
...
@user_view('osqa/users/reputation.html', 'reputation', _('user reputation in the community'), _('profile - user reputation'))
...
@user_view('osqa/users/questions.html', 'favorites', _('favorite questions'),  _('profile - favorite questions'), True)
...
@user_view('osqa/users/subscriptions.html', 'subscriptions', _('subscription settings'), _('profile - subscriptions'), True)
...
def account_settings(request):
    ...
    return render_to_response('osqa/account_settings.html', {
        'msg': msg,
        'is_openid': is_openid
        }, context_instance=RequestContext(request))
