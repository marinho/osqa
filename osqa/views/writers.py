...
from osqa.views.commands import SpamNotAllowedException
...
def ask(request):
    ...
    return render_to_response('osqa/ask.html', {
        'form' : form,
        #'tags' : tags,
...
def _retag_question(request, question):
    ...
    return render_to_response('osqa/question_retag.html', {
        'question': question,
        'form' : form,
        #'tags' : _get_tags_cache_json(),
    }, context_instance=RequestContext(request))
...
def _edit_question(request, question):
    ...
    return render_to_response('osqa/question_edit.html', {
        'question': question,
...
def edit_answer(request, id):
    ...
    return render_to_response('osqa/answer_edit.html', {
                              'answer': answer,
                              'revision_form': revision_form,
                              'form': form,
                              }, context_instance=RequestContext(request))
